...
//judgement - how to respond once test results are in?
	...
	["if judgement was needed, recognized others' circumstances",
	 "was quick to judge, unconcerned about circumstances",
		["empathy","judgement","independent"]],
	["recognized others' complexity, with compassion and patience",
	 "reduced other people to their results",
...
//test - how do you check if the process was a success?
	...
	["regularly tested to find faults early",
	 "didn't test enough, hoping it \'just works\' at the end",
		["craft","test","independent"]],
	["tested rigorously with novel experiments",
	 "didn't consider new circumstances while testing",
		["craft","test","expert"]],
//judgement - how to respond once test results are in?
	["accepted guidance when considering next steps",
	 "ignored others' guidance and advice",
		["craft","judgement","familiar"]],
	["found better sources to guide decisions and techniques",
	 "didn't get second opinions or discover best-practices",
		["craft","judgement","independent"]],
	["held themselves accountable to a higher standard",
